package best.leafyalex.gainzclient.bot.bots

import best.leafyalex.gainzclient.GainzClient
import best.leafyalex.gainzclient.bot.BotBase
import best.leafyalex.gainzclient.bot.features.Gap
import best.leafyalex.gainzclient.bot.features.MovePriority
import best.leafyalex.gainzclient.bot.features.Potion
...
class Combo : BotBase("/play duels_combo_duel"), MovePriority, Gap, Potion {
    ...
    override fun onTick() {
        if (opponent() != null && mc.theWorld != null && mc.thePlayer != null) {
            ...
            if (distance < (GainzClient.config?.maxDistanceAttack ?: 10)) {
            ...
            if (distance < (GainzClient.config?.maxDistanceLook ?: 150)) {
                Mouse.startTracking()
            } else {
                Mouse.stopTracking()
            }
