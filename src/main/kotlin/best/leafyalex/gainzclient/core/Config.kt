...
import best.leafyalex.gainzclient.bot.bots.*
...
class Config : Vigilant(File(GainzClient.configLocation), sortingBehavior = ConfigSorter()) {
    ...
    @Property(
        type = PropertyType.TEXT,
        name = "Discord Bot ID",
        description = "Bot to use as remote controller",
